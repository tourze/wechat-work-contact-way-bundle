 ...
 * @internal
 */
#[CoversClass(GetContactWayRequest::class)]
final class GetContactWayRequestTest extends RequestTestCase
{
    ...
    public function testRequestPath(): void
    {
        // 测试请求路径
        $request = new GetContactWayRequest();
        $this->assertStringContainsString('externalcontact/get_contact_way', $request->getRequestPath());
    }
    ...
    public function testBusinessScenarioGetSalesContactWay(): void
    {
        // 测试业务场景：获取销售联系方式配置
        $request = new GetContactWayRequest();
    ...
    public function testBusinessScenarioGetCustomerServiceContactWay(): void
    {
        // 测试业务场景：获取客服联系方式配置
        $request = new GetContactWayRequest();
        ...
        $this->assertSame($csConfigId, $json['config_id'] ?? null);
    }

    public function testBusinessScenarioGetTemporaryContactWay(): void
    {
        // 测试业务场景：获取临时联系方式配置
        $request = new GetContactWayRequest();
    ...
    public function testBusinessScenarioConfigurationManagement(): void
    {
        // 测试业务场景：配置管理
        $request = new GetContactWayRequest();
        ...
        $json = $options['json'] ?? [];
        $this->assertIsArray($json);
        $this->assertSame($managementConfigId, $json['config_id'] ?? null);

        // 验证API支持配置获取
        $this->assertStringContainsString('get_contact_way', $request->getRequestPath());
    }

    public function testBusinessScenarioConfigurationValidation(): void
    {
        // 测试业务场景：配置验证
        $request = new GetContactWayRequest();
        ...
        $json = $options['json'] ?? [];
        $this->assertIsArray($json);
        $this->assertSame($validationConfigId, $json['config_id'] ?? null);
    }
